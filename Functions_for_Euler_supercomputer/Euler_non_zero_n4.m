...
Mav_plot(n, wRb, n, n, theta, beta,  D, F, Feff, M,Meff, Heff, R, Op, bRp, worthF, worthM, worthH, number_of_directions, true, TRI, F_surf, F_vol, M_surf, M_vol)
filename = ['Optimization_beta_theta_max(M,F)_in_(x,y,z)_n=' num2str(n) '_init_non_zero.fig'];
