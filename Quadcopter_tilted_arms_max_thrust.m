function [alphastar, nstar, exitflag] = Quadcopter_tilted_arms_max_thrust(kf, nmin, nmax, alphamin, alphamax, alpha0, n0, d, beta, theta, wRb, Display, Algorithm, maxIter, StepTolerance, ConstraintTolerance)
...
fun = @(x) -sqrt((wRb(1,1)*(kf*(sin(x(1))*sin(theta(1)) + cos(x(1))*sin(beta(1))*cos(theta(1)))*x(5)^2 ...
                ...
                +wRb(1,2)*(-kf*(sin(x(1))*cos(theta(1)) - cos(x(1))*sin(beta(1))*sin(theta(1)))*x(5)^2 ...
                ...
                +wRb(1,3)*(kf*cos(x(1))*cos(beta(1))*x(5)^2 + kf*cos(x(2))*cos(beta(2))*x(6)^2 ...
                           +kf*cos(x(3))*cos(beta(3))*x(7)^2+ kf*cos(x(4))*cos(beta(4))*x(8)^2))^2 ...
               +(wRb(2,1)*(kf*(sin(x(1))*sin(theta(1)) + cos(x(1))*sin(beta(1))*cos(theta(1)))*x(5)^2 ...
                           +kf*(sin(x(2))*cos(theta(2)) - cos(x(2))*sin(beta(2))*sin(theta(2)))*x(6)^2 ...
                           -kf*(sin(x(3))*sin(theta(3)) + cos(x(3))*sin(beta(3))*cos(theta(3)))*x(7)^2 ...
                           -kf*(sin(x(4))*cos(theta(4)) - cos(x(4))*sin(beta(4))*sin(theta(4)))*x(8)^2) ...
                +wRb(2,2)*(-kf*(sin(x(1))*cos(theta(1)) - cos(x(1))*sin(beta(1))*sin(theta(1)))*x(5)^2 ...
                           +kf*(sin(x(2))*sin(theta(2)) + cos(x(2))*sin(beta(2))*cos(theta(2)))*x(6)^2 ...
                           +kf*(sin(x(3))*(cos(theta(3))) - cos(x(3))*sin(beta(3))*sin(theta(3)))*x(7)^2 ...
                           -kf*(sin(x(4))*sin(theta(4)) + cos(x(4))*sin(beta(4))*cos(theta(4)))*x(8)^2) ...
                +wRb(2,3)*(kf*cos(x(1))*cos(beta(1))*x(5)^2 + kf*cos(x(2))*cos(beta(2))*x(6)^2 ...
                           +kf*cos(x(3))*cos(beta(3))*x(7)^2+ kf*cos(x(4))*cos(beta(4))*x(8)^2))^2 ...
               +(wRb(3,1)*(kf*(sin(x(1))*sin(theta(1)) + cos(x(1))*sin(beta(1))*cos(theta(1)))*x(5)^2 ...
                           +kf*(sin(x(2))*cos(theta(2)) - cos(x(2))*sin(beta(2))*sin(theta(2)))*x(6)^2 ...
                           -kf*(sin(x(3))*sin(theta(3)) + cos(x(3))*sin(beta(3))*cos(theta(3)))*x(7)^2 ...
                           -kf*(sin(x(4))*cos(theta(4)) - cos(x(4))*sin(beta(4))*sin(theta(4)))*x(8)^2) ...
                +wRb(3,2)*(-kf*(sin(x(1))*cos(theta(1)) - cos(x(1))*sin(beta(1))*sin(theta(1)))*x(5)^2 ...
                           +kf*(sin(x(2))*sin(theta(2)) + cos(x(2))*sin(beta(2))*cos(theta(2)))*x(6)^2 ...
                           +kf*(sin(x(3))*(cos(theta(3))) - cos(x(3))*sin(beta(3))*sin(theta(3)))*x(7)^2 ...
                           -kf*(sin(x(4))*sin(theta(4)) + cos(x(4))*sin(beta(4))*cos(theta(4)))*x(8)^2) ...
                +wRb(3,3)*(kf*cos(x(1))*cos(beta(1))*x(5)^2 + kf*cos(x(2))*cos(beta(2))*x(6)^2 ...
                           +kf*cos(x(3))*cos(beta(3))*x(7)^2+ kf*cos(x(4))*cos(beta(4))*x(8)^2))^2); 
...
% actual optimization
[xstar,fval,exitflag,output] = fmincon(fun, x0, A, b, Aeq, beq, lb, ub, @(x) nonlinconF(x, kf, theta, beta, d, wRb),  options);
