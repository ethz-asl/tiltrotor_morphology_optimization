...
[pdotdot, wbdot] = quadRotorTiltedDynamic(kf, km, Ib, wRb, alphastar,nstar, L, g, m);
...
figure(1);
fill3(F1(1,:),F1(2,:),F1(3,:),'b', 'FaceAlpha', 0.4); hold on;
fill3(F2(1,:),F2(2,:),F2(3,:),'b', 'FaceAlpha', 0.4);
fill3(F3(1,:),F3(2,:),F3(3,:),'b', 'FaceAlpha', 0.4);
fill3(F4(1,:),F4(2,:),F4(3,:),'b', 'FaceAlpha', 0.4);
fill3(F5(1,:),F5(2,:),F5(3,:),'b', 'FaceAlpha', 0.4);
fill3(F6(1,:),F6(2,:),F6(3,:),'b', 'FaceAlpha', 0.4);
fill3(F7(1,:),F7(2,:),F7(3,:),'b', 'FaceAlpha', 0.4);
fill3(F8(1,:),F8(2,:),F8(3,:),'b', 'FaceAlpha', 0.4);
fill3(F9(1,:),F9(2,:),F9(3,:),'b', 'FaceAlpha', 0.4);
fill3(F10(1,:),F10(2,:),F10(3,:),'b', 'FaceAlpha', 0.4);
fill3(F11(1,:),F11(2,:),F11(3,:),'b', 'FaceAlpha', 0.4);
fill3(F12(1,:),F12(2,:),F12(3,:),'b', 'FaceAlpha', 0.4);
fill3(F13(1,:),F13(2,:),F13(3,:),'b', 'FaceAlpha', 0.4);
fill3(F14(1,:),F14(2,:),F14(3,:),'b', 'FaceAlpha', 0.4);
fill3(F15(1,:),F15(2,:),F15(3,:),'b', 'FaceAlpha', 0.4);
fill3(F16(1,:),F16(2,:),F16(3,:),'b', 'FaceAlpha', 0.4);
fill3(F17(1,:),F17(2,:),F17(3,:),'b', 'FaceAlpha', 0.4);
fill3(F18(1,:),F18(2,:),F18(3,:),'b', 'FaceAlpha', 0.4);
fill3(F19(1,:),F19(2,:),F19(3,:),'b', 'FaceAlpha', 0.4);
fill3(F20(1,:),F20(2,:),F20(3,:),'b', 'FaceAlpha', 0.4);
fill3(F21(1,:),F21(2,:),F21(3,:),'b', 'FaceAlpha', 0.4);
fill3(F22(1,:),F22(2,:),F22(3,:),'b', 'FaceAlpha', 0.4);
fill3(F23(1,:),F23(2,:),F23(3,:),'b', 'FaceAlpha', 0.4);
fill3(F24(1,:),F24(2,:),F24(3,:),'b', 'FaceAlpha', 0.4);

% Generate a sphere consisting of 20by 20 faces of radius Fmin
[x,y,z]=sphere;
% use surf function to plot
hSurface=surf(Fmin*x,Fmin*y,Fmin*z);
hold on;
...
[x,y,z]=sphere;
% use surf function to plot
hSurface=surf(Mmin*x,Mmin*y,Mmin*z);
hold on
set(hSurface,'FaceColor',[1 0 0], ...
   'FaceAlpha',0.3,'FaceLighting','gouraud','EdgeColor','none')
%axis([-20 20 -20 20 -20 20]);
